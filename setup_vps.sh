...
# Usage: curl -sSL https://raw.githubusercontent.com/YOUR_USERNAME/abis/main/setup_vps.sh | bash
# Or: wget -qO- https://raw.githubusercontent.com/YOUR_USERNAME/abis/main/setup_vps.sh | bash
